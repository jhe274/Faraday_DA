...
class Theory:
    ...
    def FR_theta(self, Lambda, l, B, T, Lambda_D1, Lambda_D2):
        ...
        print(f"Zeeman splitting of K D1 line with B={round(B*pow(10,4),3)} G is " + str(Delta_Lambda_D1*pow(10,9)) + " nm = " + str(Delta_nu_D1*pow(10,-9)) + " GHz")
        print(f"Zeeman splitting of K D2 line with B={round(B*pow(10,4),3)} G is " + str(Delta_Lambda_D2*pow(10,9)) + " nm = " + str(Delta_nu_D2*pow(10,-9)) + " GHz")
