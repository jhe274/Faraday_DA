...
## **Overview**
This repository provides a comprehensive **data analysis pipeline** for **polarization modulation ellipsometry (PME) measurements** using Python. It includes modules for **data acquisition, processing, visualization, theoretical calculations, and curve fitting** to support experimental physics research.
